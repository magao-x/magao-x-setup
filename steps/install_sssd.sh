...
dnf --setopt=timeout=300 --setopt=retries=10 -y install sssd oddjob-mkhomedir sssd-ldap sssd-tools || exit_with_error "Failed to install distro packages for SSSD or mkhomedir"

...
sudo -H /opt/conda/bin/mamba env update --yes -p /opt/conda/envs/$JUPYTERHUB_ENV_NAME -f $DIR/../conda_env_jupyterhub.yml || exit_with_error "Failed to install or update packages for JupyterHub env"
